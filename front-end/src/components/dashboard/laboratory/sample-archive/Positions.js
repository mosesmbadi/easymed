...
import { getAllArchivePositions, getAllArchiveSections } from '@/redux/features/laboratory';
...
const Positions = () => {
    ...
    const { archivePositions, archiveSections } = useSelector((store) => store.laboratory);
