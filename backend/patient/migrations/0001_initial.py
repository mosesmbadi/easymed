    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='triages', to='patient.patient')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.TextField(max_length=300)),
                ('track', models.CharField(choices=[('reception', 'Reception'), ('triage', 'Triage'), ('doctor', 'Doctor'), ('pharmacy', 'Pharmacy'), ('lab', 'Lab'), ('awaiting result', 'Result'), ('added result', 'Resulted'), ('inpatient', 'Inpatient'), ('billing', 'Billing'), ('complete', 'Complete')], default='reception', max_length=50)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_attendance_processes', to=settings.AUTH_USER_MODEL)),
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient.patient')),
                ('prescription', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='attendace_prescription', to='patient.prescription')),
