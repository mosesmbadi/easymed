...
router.register(
    r"patient-admissions", PatientAdmissionViewSet, basename="patient-admission"
)
router.register(r"wards", WardViewSet, basename="ward")
router.register(r"beds", BedViewSet, basename="bed")
router.register(
    r"ward-nurse-assignments",
    WardNurseAssignmentViewSet,
    basename="ward-nurse-assignment",
)
